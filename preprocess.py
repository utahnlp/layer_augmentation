...
def main(arguments):
	...
	parser.add_argument('--vocabsize', help="Size of source vocabulary, constructed by taking the top X most frequent words. Rest are replaced with special UNK tokens.",
